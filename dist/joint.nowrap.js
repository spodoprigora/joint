...
joint.routers.crossManhattan = (function(g, _, joint) {
  ...
  ObstacleMap.prototype.buildLinkMap = function(paper, graph, link) {
    var opt = this.options;
    ...
    _.each(links, function(link, i){
      ...
      if(linkView && linkView.route){
        linksPoints.push(linkView.route)
      }
    })
  ...
  function router(vertices, opt) {
    ...
    var map = obstracleMap.build(this.paper.model, this.model);
    obstracleMap.buildLinkMap(this.paper, this.paper.model, this.model)
